...
<a href="index.php?do=model&model_id=7&view=list&w[service_id]=&w[service_status]=&w[title]=&w[username]=&page=1&page_size=10&ac=pass&service_id=11&page=1"  onclick="return cdel(this,'确定上架此商品吗？');" class="button"><span class="cog icon"></span>上架</a>
</td>
            </tr>
                        <tr class="item">
...
<a href="index.php?do=model&model_id=7&view=list&w[service_id]=&w[service_status]=&w[title]=&w[username]=&page=1&page_size=10&ac=pass&service_id=10&page=1"  onclick="return cdel(this,'确定上架此商品吗？');" class="button"><span class="cog icon"></span>上架</a>
</td>
            </tr>
                        <tr class="item">
...
<a href="index.php?do=model&model_id=7&view=list&w[service_id]=&w[service_status]=&w[title]=&w[username]=&page=1&page_size=10&ac=pass&service_id=6&page=1"  onclick="return cdel(this,'确定上架此商品吗？');" class="button"><span class="cog icon"></span>上架</a>
</td>
            </tr>
                        <tr class="item">
...
<a href="index.php?do=model&model_id=7&view=list&w[service_id]=&w[service_status]=&w[title]=&w[username]=&page=1&page_size=10&ac=pass&service_id=4&page=1"  onclick="return cdel(this,'确定上架此商品吗？');" class="button"><span class="cog icon"></span>上架</a>
</td>
            </tr>
                        <tr class="item">
...
<a href="index.php?do=model&model_id=7&view=list&w[service_id]=&w[service_status]=&w[title]=&w[username]=&page=1&page_size=10&ac=pass&service_id=3&page=1"  onclick="return cdel(this,'确定上架此商品吗？');" class="button"><span class="cog icon"></span>上架</a>
</td>
            </tr>
