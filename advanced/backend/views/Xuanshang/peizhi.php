...
<div class="page_title">
  <h1>单人悬赏任务配置</h1>
    <div class="tool">
      <a href="index.php?do=model&model_id=1&view=config&op=config" class="here">基本配置</a>
      <a href="index.php?do=model&model_id=1&view=config&op=control">流程配置</a>
      <a href="index.php?do=model&model_id=1&view=config&op=priv">权限配置</a>
     </div>
</div>
<div class="box post">
 <div class="tabcon">
...
<!-- <tr>
 ...
 <tr>
    <th scope="row" width="200">模型说明：</th>
      <td>
       <textarea cols=110 rows=12 name="fds[model_desc]"  style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://localhost/weike/',tools:'simple',skin:'nostyle',admin:'../../',html5Upload:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=att'}" cols="70">&lt;p&gt;&nbsp;&nbsp;&nbsp;&nbsp;&lt;strong&gt; 单人悬赏常用于发布一些时间短，需要创意型的任务，例如给宝宝起名，店铺起名，设计网站logo，贺卡设计，找人排队跑腿，写广告语，策划活动等等是的吧&lt;/strong&gt;&lt;/p&gt;</textarea>
  </td>
         </tr>
  <tr>
