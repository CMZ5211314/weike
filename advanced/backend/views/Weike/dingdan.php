...
value="80004486" class="checkbox">80004486</td>
<td class="obj_link">
购买商品<a href="index.php?do=service&sid=12">商务|贸易|通用PPT模板</a></td>
<td>￥100.00元</td>
<td></td>
<td>admin</td>
<td>
2014-12-05 14:01:18</td>
<td><a onclick="return cdel(this);"
href='index.php?do=model&model_id=6&view=order&w[order_id]=&w[order_username]=&w[order_status]=&page=1&w[page_size]=10&ord[0]=&ord[1]=&ac=del&order_id=80004486&page=1'
class="button"><span class="trash icon"></span>删除</a>
</td>
</tr>
<tr class="item">
<td><input type="checkbox" name="ckb[]"
value="80004485" class="checkbox">80004485</td>
<td class="obj_link">
...
<td>admin</td>
<td>
2014-12-05 13:59:10</td>
<td><a onclick="return cdel(this);"
href='index.php?do=model&model_id=6&view=order&w[order_id]=&w[order_username]=&w[order_status]=&page=1&w[page_size]=10&ord[0]=&ord[1]=&ac=del&order_id=80004485&page=1'
class="button"><span class="trash icon"></span>删除</a>
</td>
</tr>
<tr class="item">
...
var url_link = "http://localhost/weike/";
$(function(){
