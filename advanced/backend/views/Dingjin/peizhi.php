...
<div class="page_title">
  <h1>订金招标任务配置</h1>
    <div class="tool">
      <a href="index.php?do=model&model_id=5&view=config&op=config" class="here">基本配置</a>
      <a href="index.php?do=model&model_id=5&view=config&op=control">流程配置</a>
      <a href="index.php?do=model&model_id=5&view=config&op=priv">权限配置</a>
     </div>
</div>
<div class="box post">
 <div class="tabcon">
