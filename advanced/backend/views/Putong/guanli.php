...
<a href="index.php?do=model&model_id=4&view=list&ac=del&task_id=56&page=1"  onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
</td>
                  </tr>
                                    <tr class="item">
...
<a href="index.php?do=model&model_id=4&view=list&ac=del&task_id=53&page=1"  onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
</td>
                  </tr>
                                    <tr class="item">
...
<a href="index.php?do=model&model_id=4&view=list&ac=del&task_id=47&page=1"  onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
</td>
                  </tr>
                                    <tr class="item">
