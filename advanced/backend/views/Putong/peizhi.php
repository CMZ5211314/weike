...
<div class="page_title">
  <h1>普通招标任务配置</h1>
    <div class="tool">
      <a href="index.php?do=model&model_id=4&view=config&op=config" class="here">基本配置</a>
      <a href="index.php?do=model&model_id=4&view=config&op=control">流程配置</a>
      <a href="index.php?do=model&model_id=4&view=config&op=priv">权限配置</a>
     </div>
</div>
<div class="box post">
 <div class="tabcon">
...
<br class="clear">(如果指定行业后,则任务的行业类型将是这里指定行业类型；如果不指定行业，则任务类型将是系统指定的所有行业类型.)</td>
 ...
 <tr>
    <th scope="row" width="200">模型说明：</th>
      <td>
        <textarea cols=110 rows=12 name="fds[model_desc]"  style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://localhost/weike/',tools:'simple',skin:'nostyle',admin:'../../',html5Upload:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=att'}" cols="70">&lt;p&gt;普通招标，雇主选择中标者后，交付将在线下完成，雇主确认后，任务完成，普能招标，网站只收取固定的服务费用,&lt;/p&gt;&lt;p&gt;普通招标将不能增涨双方的信誉值，与能力值&lt;br /&gt;&lt;/p&gt;&lt;br /&gt;</textarea>
  </td>
         </tr>
  <tr>
