...
<br/>&nbsp;&nbsp;网站名称并非网站标题,仅在页底显示及发送邮件等处使用 
                      ...
                      <tr>
                        ...
                        <td><input type="text" size="50" name="website_url"  value="http://localhost/weike" maxlength="100" limit="required:true;len:3-100;general:false" msg="网站地址不正确，长度3-100" msgArea="web_url_msg" class="txt"/>
         ...
         <th scope="row">
            ...
            <tr>
                <th scope="row">
                    联系地址：                </th>
                <td>
                    <input type="text" size="50" maxlength="200" name="address" value="河南省南阳市" limit="len:3-200;general:false" msg="联系地址长度：3-200" msgArea="txt_address_msg" class="txt"/><span id="txt_address_msg"></span><br/>&nbsp;&nbsp;将显示在页面底部的联系方式处                </td>
            </tr>
            <tr>
                <th scope="row">
                    联系电话：                </th>
                <td>
                    <input type="text" size="50" maxlength="20" name="phone" value="15010390391" class="txt"/><br/>&nbsp;&nbsp;将显示在页面底部的联系方式处                </td>
            </tr>
            <tr>
                <th scope="row">
                    客服电话：                </th>
                <td>
                    <input type="text" size="50" maxlength="100" name="kf_phone" value="0394-5739002" class="txt"/><br/>&nbsp;&nbsp;（多个以逗号隔开）将显示在页面底部的联系方式处                </td>
            </tr>
            <tr>
                <th scope="row">
                    邮编：                </th>
                <td>
                    <input type="text" size="50" name="postcode" value="473000" limit="len:0-10" msg="邮编不正确" msgArea="txt_post_msg" class="txt"/><span id="txt_post_msg"></span><br/>&nbsp;&nbsp;将显示在页面底部的联系方式处                </td>
            </tr>
