<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_user_list', '1417743309' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<th width="45"><?php echo $_lang['cash_coupon'];?></th>
...
<?php if(is_array($userlist_arr)) { foreach($userlist_arr as $key => $value) { ?>
        <tr class="item">
        	<td class="td25"><input type="checkbox" name="ckb[]" class="checkbox" value="<?php echo $value['uid'];?>"></td>
...
<td><?php if($value['reg_time']){echo date('Y-m-d',$value['reg_time']); } ?></td>
            ...
            <td><div class="ws_break" style="width:70%;"><?php echo $value['credit'];?></div></td>
