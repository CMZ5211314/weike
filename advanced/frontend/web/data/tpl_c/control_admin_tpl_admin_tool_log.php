<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_tool_log', '1417744628' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id="append_parent"></div> 
 ...
 <div class="page_title">
    	<h1><?php echo $_lang['system_log'];?></h1>
          <div class="tool">          
<a href="index.php?do=tool&view=log" <?php if($view == 'log') { ?>class="here"<?php } ?> ><?php echo $_lang['log'];?></a>
