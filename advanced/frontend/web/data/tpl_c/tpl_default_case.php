<?php keke_tpl_class::checkrefresh('tpl/default/case', '1417682601' );?><?php if($_K['inajax']) { ?>
...
<header class="clearfix page_header">
        ...
        <!--页面导航-->
        	<div class="breadcrumbs clearfix">
            	<a href="#"><?php echo $_lang['home'];?></a> &gt; <span><?php echo $_lang['success_case'];?></span>
        	</div>
        <!--end 页面导航-->
...
<a <?php if($v['obj_type']=='task') { ?> href="index.php?do=task&task_id=<?php echo $v['obj_id']?>" <?php } else { ?> href="index.php?do=service&sid=<?php echo $v['obj_id']?>" <?php } ?> ><img src="<?php if($v['case_img']) { ?><?php echo $v['case_img']?><?php } else { ?><?php echo 'resource/img/system/shop_default_big.jpg' ?><?php } ?>" 
onerror="this.src='resource/img/style/shop_default_big.jpg'" alt="<?php if($v['obj_type']=='task') { ?><?php echo $v['task_title'];?><?php } else { ?><?php echo $v['title'];?><?php } ?>" title="<?php if($v['obj_type']=='task') { ?><?php echo $v['task_title'];?><?php } else { ?><?php echo $v['title'];?><?php } ?>"></a>


<div class="mt_5 img_title clearfix">
<a <?php if($v['obj_type']=='task') { ?>
 href="index.php?do=task&task_id=<?php echo $v['obj_id']?>" 
 <?php } else { ?> href="index.php?do=service&sid=<?php echo $v['obj_id']?>"<?php } ?> class="case_name" title="<?php echo $v['case_title']?>"><span class="font14 cc00 mr_5"><?php  echo keke_curren_class::output(floatval($v['case_price']),-1);  ?></span><?php echo $v['case_title']?></a>
</div>

<div class="clearfix">
<?php if($v['obj_type']=='service') { ?>
<span style="color:#2f549f;"><?php echo $indus_arr[$v['c_indus_pid']]['indus_name'];?> / <?php echo $indus_arr[$v['c_indus_id']]['indus_name']?></span>
<?php } else { ?>	
<span style="color:#2f549f;"><?php echo $indus_arr[$v['b_indus_pid']]['indus_name']?> / <?php echo $indus_arr[$v['b_indus_id']]['indus_name']?> </span>
<?php } ?>
...
<script type="text/javascript" src="<?php echo SKIN_PATH;?>/js/masonry_img.js"></script>
<?php if(!isset($inajax)) { ?>
